...
public class EffectDelete extends ControlEffect {
    ...
    public void preCompile(Context context, Pattern.Match match) throws Throwable {
        ...
        if (inputs[0].current() instanceof ExprVariable)
    ...
    public void compile(Context context, Pattern.Match match) throws Throwable {
        ...
        final ElementTree tree = context.getCompileCurrent();
        final ElementTree[] inputs = tree.nested();
        if (!(inputs[0].current() instanceof ExprVariable)) { // variables have to handle their own deletion
