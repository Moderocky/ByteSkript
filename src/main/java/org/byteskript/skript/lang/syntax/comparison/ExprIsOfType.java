...
import org.byteskript.skript.lang.syntax.type.ExprType;
...
public class ExprIsOfType extends RelationalExpression {
    ...
    public void compile(Context context, Pattern.Match match) throws Throwable {
        ...
        if (tree.nested()[1].current() instanceof ExprType expression) {
    ...
    public void preCompile(Context context, Pattern.Match match) throws Throwable {
        ...
        if (tree.current() instanceof ExprType) {
            tree.compile = false;
        }
    }
