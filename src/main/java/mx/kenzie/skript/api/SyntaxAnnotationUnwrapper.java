...
import mx.kenzie.skript.api.automatic.*;
...
public interface SyntaxAnnotationUnwrapper extends Library {
    ...
    default void generateSyntaxFrom(Class<?> owner) {
        ...
        event:
        {
            ...
            final mx.kenzie.skript.api.note.Event event = owner.getAnnotation(mx.kenzie.skript.api.note.Event.class);
        ...
        for (Method method : owner.getDeclaredMethods()) {
            ...
            property:
            {
                final mx.kenzie.skript.api.note.Property property = method.getAnnotation(Property.class);
