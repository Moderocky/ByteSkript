...
public class ValuesOfMap extends PropertyExpression {
    
    public ValuesOfMap() {
        super(SkriptLangSpec.LIBRARY, CommonTypes.LIST, "(values|contents)");
        try {
            handlers.put(StandardHandlers.GET, ValuesOfMap.class.getMethod("get", Object.class));
    ...
    public static DataList get(Object target) {
        ...
        return new DataList(map.values());
    }
